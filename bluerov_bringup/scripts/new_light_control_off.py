    ...
    def callback(self, apriltag_data):
        ...
        if (apriltag_data.detections):
            ...
            if not self.first_msg_received:
                self.turn_off_lights(light_controller.LIGHT_1)
                self.turn_off_lights(light_controller.LIGHT_2)
                self.turn_off_lights(light_controller.LIGHT_3)
                self.turn_off_lights(light_controller.LIGHT_4)
